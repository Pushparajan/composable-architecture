...
- The specific Content Credentials behavior of each Firefly Services endpoint after editing operations.
- The public verification URL used in earlier drafts of this series; I removed it rather than guess.
- Current contract terms. They vary by customer.

## LinkedIn kit

**Post**

Indemnification isn't a feature flag. It's a contract line.

When a legal team asks about Firefly output, three things come up. Here's what Adobe's public materials say.

Training data. Adobe says Firefly models are trained only on content it has permission to use, including Adobe Stock and public domain material.

Indemnification. Enterprise customers can purchase an entitlement with contractual IP indemnification for select Firefly outputs, through certain plans. Covered features and liability caps are in Adobe's legal FAQ and your own agreement. That's for your counsel to interpret, not something a developer should promise for them.

Provenance. Adobe says Content Credentials are applied automatically to assets fully generated by Firefly. In the Image5 API, CAI output settings are no longer configurable.

The dev homework: resize or re-encode an output and check whether the credentials survive.

What does your legal team ask about first?

**Alternate hooks**
- "Is it commercially safe?" is really three questions. Here's how I'd split them.
- Content Credentials are easy to lose in a pipeline. Test yours.

**First comment:** Adobe's approach: https://business.adobe.com/products/firefly-business/firefly-ai-approach.html Enterprise legal FAQ: https://www.adobe.com/cc-shared/assets/pdf/enterprise/firefly-legal-faqs-enterprise-customers-2024-06-11.pdf
