# Content Supply Chain series: article intros

Short intros (2-3 sentences) for each article, written for developers by an Adobe multi-solution architect. Use them as the lede on an article page, in a series index, or in a newsletter. They are separate from the front matter `description` (which stays under 160 characters for SEO).
...
`csc-01-one-app-is-not-the-suite`
...
`csc-03-why-a-new-hire-cant-open-genstudio`
...
`csc-04-one-org-many-brands-and-agencies`
...
`csc-05-workspaces-should-mirror-your-org`
...
`csc-09-free-text-breaks-reports`
...
`csc-10-attach-dont-upload-again`
...
`csc-11-unified-view-without-migration`
...
`csc-14-approval-should-be-an-event`
...
`csc-15-native-first-fusion-second-custom-last`
...
`csc-16-paid-and-owned-are-different-planes`
...
`csc-17-which-asset-drove-the-outcome`
...
`csc-19-the-seven-phase-rollout`
...
`csc-20-bonus-value-without-going-all-in`
